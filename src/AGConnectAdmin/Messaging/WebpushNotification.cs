...
namespace AGConnectAdmin.Messaging
{
    ...
    /// </summary>
    public class WebpushNotification: MessagePart<WebpushNotification>
    {
        /// <summary>
        ...
        /// <inheritdoc/>
        internal protected override WebpushNotification CopyAndValidate()
        {
            var copy = new WebpushNotification()
            {
                ...
                Silent = this.Silent,
                Actions = this.Actions?.Select(item => new WebpushAction(item)).ToList(),
